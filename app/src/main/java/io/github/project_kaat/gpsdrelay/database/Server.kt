...
data class Server(
    ...
    companion object {
        fun validateAndCreate(type : GpsdServerType, ipv4 : String, port : String, relayingEnabled: Boolean, generationEnabled: Boolean, creationTimestamp: Long, enabled: Boolean) : Server?{
            var ipv4 = ipv4.trim()
            ...
            return Server(type.code, ipv4, port.toInt(), relayingEnabled, generationEnabled, creationTimestamp, enabled)
        }
    }
}
